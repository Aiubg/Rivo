<script lang="ts" module>
	...
	export const sheetVariants = tv({
		base: 'bg-dialog text-dialog-foreground data-[state=open]:animate-in data-[state=closed]:animate-out border-border shadow-dialog data-[state=closed]:animation-duration-180 data-[state=open]:animation-duration-220 fixed z-50 flex flex-col gap-4 border transition-none data-[state=closed]:pointer-events-none data-[state=closed]:ease-in data-[state=open]:ease-out motion-reduce:data-[state=closed]:animate-none motion-reduce:data-[state=open]:animate-none',
		variants: {
			side: {
